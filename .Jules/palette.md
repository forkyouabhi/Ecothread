...
## 2026-05-10 - Bootstrap Form Validation Feedback
...
**Action:** Always include the client-side validation script when using the needs-validation class in Bootstrap forms.
