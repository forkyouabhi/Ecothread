...
## 2026-05-12 - Bootstrap Form Validation requirement
**Learning:** Bootstrap forms using the `needs-validation` class require a custom client-side JavaScript snippet to intercept form submissions and apply the `was-validated` class; without this, inline `.invalid-feedback` UI messages will not be triggered.
**Action:** When adding or fixing Bootstrap validation classes, ensure the companion JavaScript snippet is present on the page.
