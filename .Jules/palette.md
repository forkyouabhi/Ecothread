...
## 2024-05-19 - Add Bootstrap Form Validation Script
...
**Action:** Always verify that the validation script snippet is included when using `.needs-validation` in forms to ensure validation feedback is displayed to the user.
