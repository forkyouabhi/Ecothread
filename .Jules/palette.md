...
## 2024-05-30 - Bootstrap Forms Validations Feedback
...
**Action:** Always include the custom Bootstrap validation JavaScript snippet at the end of templates using the `needs-validation` class to ensure `invalid-feedback` works.
